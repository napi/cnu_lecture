...
public class PlayerTest {
	 ...
	 * 전설의 무기는 크리스탈 의자.
	 * 
	 * 다른 의자는 모두 데미지가 2로 고정이다. 전설의 의자(크리스탈 의자)는 100의 고정 데미지를 입힌다.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testSecretWeapon() throws Exception {
		...
		/**
		 * 아래 setWeapon 에 chair 을 넣으면 compile error가 난다. chair 에 WeaponStrategy
		 * 를 구현하면 compile error 가 사라질 것이다.
		 */
		// TODO 아래쪽 라인 player.setWeapon(chair); 이 컴파일 오류가 나지 않으며, assertThat 테스트
		// 구문이 통과하도록 Chair.java 파일을 수정하라.
